...
/**
 * AlarmModal - Compact add/edit alarm modal with touch-friendly spinners
 * Strict NO scrolling - all content visible at once
 */
export const AlarmModal = ({ isOpen, onClose, alarm, onSave }) => {
    ...
    const [time, setTime] = useState(alarm?.time || getCurrentTime());
    ...
    // Track the last alarm ID to detect when we're editing a different alarm
